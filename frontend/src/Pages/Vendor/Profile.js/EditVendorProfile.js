...
export const EditVendorProfile = () => {
    ...
    const { firstName, lastName, phone, country, city, username, email, shopAddress, postalCode, shopName } = user;
                                ...
                                <div className="col-xs-4 col-xs-offset-4 mr-4">
                                 ...
                                 <span className = 'float-right change w-50 text-center'><Link>Change</Link></span>
                                    ...
                                    <div>
                                        ...
                                        <div className="floating-label-group">
                                            <input onChange={handleProfileChnage} value={shopName} name='shopName' type="text" className="form-control" autofocus required />
                                            <label className="floating-label">Shop Name</label>
                                        </div>
                                        <div className="floating-label-group">
                                            <input onChange={handleProfileChnage} value={shopAddress} name='shopAddress' type="text" className="form-control" autofocus required />
